...
////////////////////////////////////////////////////////////////////////////////
///
void D3DCell::WriteInfo() { LOGSVC_INFO("Geometry","The Dose3D cell {} info: Implement me.", GetName()); }

////////////////////////////////////////////////////////////////////////////////
///
void D3DCell::Destroy() {
  LOGSVC_INFO("Geometry","Destroing the D3DCell volume.");
...
void D3DCell::DefineSensitiveDetector() {
  ...
  if (m_patientSD.Get() == 0) {
    ...
    LOGSVC_DEBUG("Geometry","Construct SD >> current centre {} {} {}", centre.x(), centre.y(), centre.z());
